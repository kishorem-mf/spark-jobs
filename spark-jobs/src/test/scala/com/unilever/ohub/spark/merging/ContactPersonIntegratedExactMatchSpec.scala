...
case class ResultContactPerson(sourceEntityId: String, ohubId: Option[String], firstName: Option[String], emailAddress: Option[String], mobileNumber: Option[String])
...
class ContactPersonIntegratedExactMatchSpec extends SparkJobSpec with TestContactPersons {
  ...
  private val contactPersonA2 = defaultContactPersonWithSourceEntityId("200").copy(ohubId = None, firstName = Some("Jan"), emailAddress = Some("jan@server.com"), mobileNumber = Some("12345"))
  private val contactPersonA3 = defaultContactPersonWithSourceEntityId("100").copy(ohubId = None, firstName = Some("Jansen"), emailAddress = Some("jan@server.com"), mobileNumber = Some("12345"))
  private val contactPersonA4 = defaultContactPersonWithSourceEntityId("100").copy(ohubId = None, firstName = Some("Jan"), emailAddress = Some("jansen@server.com"), mobileNumber = Some("12345"))
  private val contactPersonB2 = defaultContactPersonWithSourceEntityId("100").copy(ohubId = None, firstName = Some("Piet"), emailAddress = Some("piet@server.com"), mobileNumber = Some("12345"))
  private val contactPersonA5 = defaultContactPersonWithSourceEntityId("103").copy(ohubId = None, firstName = Some("Jan"), emailAddress = Some("jan@server.com"), mobileNumber = Some("12345"))
  private val contactPersonA6 = defaultContactPersonWithSourceEntityId("200").copy(ohubId = Some("AAA"), firstName = Some("Jan"), emailAddress = Some("jan@server.com"), mobileNumber = Some("12345"))
  ...
  describe("ContactPersonIntegratedExactMatch.transform") {
    ...
    it("should add a new entity to an existing group in integrated") {
      ...
      val expectedMatchedExact = Set(
        ResultContactPerson("100", Some("AAA"), Some("Jan"), Some("jan@server.com"), Some("12345")),
        ResultContactPerson("200", Some("AAA"), Some("Jan"), Some("jan@server.com"), Some("12345"))
      )
    ...
    it("should update an existing entity in integrated when email changed") {
      ...
      val expectedMatchedExact = Set(
        ResultContactPerson("100", Some(COPY_GENERATED), Some("Jan"), Some("jansen@server.com"), Some("12345")) // copy ohub id of actual result
      )
      val expectedUnmatchedIntegrated = Set(
        ResultContactPerson("100", Some(COPY_GENERATED), Some("Jan"), Some("jansen@server.com"), Some("12345"))
      )
    ...
    it("should merge two existing entities in one ohub group on exact match") {
      ...
      val expectedMatchedExact = Set(
        ResultContactPerson("100", Some("BBB"), Some("Piet"), Some("piet@server.com"), Some("12345")),
        ResultContactPerson("200", Some("BBB"), Some("Piet"), Some("piet@server.com"), Some("12345"))
      )
      val expectedUnmatchedIntegrated = Set(
        ResultContactPerson("100", Some("BBB"), Some("Piet"), Some("piet@server.com"), Some("12345"))
    ...
    it("should merge two existing entities in one ohub group on exact match and preserve ohub id") {
      ...
      val expectedMatchedExact = Set(
        ResultContactPerson("100", Some("BBB"), Some("Piet"), Some("piet@server.com"), Some("12345")),
        ResultContactPerson("200", Some("BBB"), Some("Piet"), Some("piet@server.com"), Some("12345")),
        ResultContactPerson("103", Some("AAA"), Some("Jan"), Some("jan@server.com"), Some("12345"))
      )
      val expectedUnmatchedIntegrated = Set(
        ResultContactPerson("100", Some("BBB"), Some("Piet"), Some("piet@server.com"), Some("12345")),
        ResultContactPerson("103", Some("AAA"), Some("Jan"), Some("jan@server.com"), Some("12345"))
    ...
    it("should lose both ohub id's when both exact match strings have changed") {
      ...
      val expectedMatchedExact = Set(
        ResultContactPerson("100", Some(COPY_GENERATED), Some("Piet"), Some("piet@server.com"), Some("12345")),
        ResultContactPerson("200", Some(COPY_GENERATED), Some("Kees"), Some("kees@server.com"), Some("12345"))
      ) // you could argue to keep the ohub id for this one?
    ...
    it("should give two new contactpersons with the same matching string the same ohubId") {
      ...
      val expectedMatchedExact = Set(
        ResultContactPerson("100", Some("COPY_GENERATED"), Some("Jansen"), Some("jan@server.com"), Some("12345")),
        ResultContactPerson("103", Some("COPY_GENERATED"), Some("Jan"), Some("jan@server.com"), Some("12345")))
    ...
    it("a contact person without an exact match string should be in unmatched") {
      ...
      val expectedMatchedExact = Set(
        ResultContactPerson("100", Some("AAA"), Some("Jan"), Some("jan@server.com"), Some("12345")),
        ResultContactPerson("200", Some("BBB"), Some("Piet"), None, None),
        ResultContactPerson("101", Some("AAA"), Some("Jan"), None, None))
      val expectedUnmatchedIntegrated = Set(
        ResultContactPerson("100", Some("AAA"), Some("Jan"), Some("jan@server.com"), Some("12345")),
        ResultContactPerson("200", Some("BBB"), Some("Piet"), None, None))
      val expectedUnmatchedDelta = Set[ResultContactPerson]()
  ...
  private def createActualResultSet(actualDataSet: Dataset[ContactPerson]): Set[ResultContactPerson] =
    actualDataSet.map(cp ⇒ ResultContactPerson(cp.sourceEntityId, cp.ohubId, cp.firstName, cp.emailAddress, cp.mobileNumber)).collect().toSet

  private def createDataset(contactPersons: ContactPerson*): Dataset[ContactPerson] = contactPersons.toDataset

  def copyOhubIds(expectedSet: Set[ResultContactPerson], actualSet: Map[String, ContactPerson]) = {
