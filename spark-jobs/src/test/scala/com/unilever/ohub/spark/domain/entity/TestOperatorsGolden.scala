...
trait TestOperatorsGolden {
  ...
  lazy val defaultOperatorGolden: OperatorGolden = OperatorGolden(
    ...
    additionalTags = Some("additionalTags"),
    advertisementId = Some("advertisementId"),
    deviceId = Some("deviceId"),
    googlePlacesId = Some("googlePlacesId"),
    internationalMapCode = Some("internationalMapCode"),
    ipAddress = Some("ipAddress"),
    nationalMapCode = Some("nationalMapCode"),
