...
object OperatorConverter extends CommonDomainGateKeeper[Operator] with OperatorEmptyParquetWriter {
  ...
  override def toDomainEntity: DomainTransformer ⇒ Row ⇒ Operator = { transformer ⇒ row ⇒
    ...
    Operator(
      ...
      annualTurnover                = optional  ( "annualTurnover",               "annualTurnover",               toBigDecimal                              ),
      averagePrice                  = optional  ( "averagePrice",                 "averagePrice",                 toBigDecimal                              ),
      averageRating                 = optional  ( "averageRating",                "averageRating",                toInt                              ), //rating for 1 - 5
      beveragePurchasePotential     = optional  ( "beveragePurchasePotential",    "beveragePurchasePotential",    toBigDecimal                              ),
      buildingSquareFootage         = optional  ( "buildingSquareFootage",        "buildingSquareFootage"                                               ),
      ...
      headQuarterAddress            = optional  ( "headQuarterAddress",           "headQuarterAddress"                                        ),
      headQuarterCity               = optional  ( "headQuarterCity",              "headQuarterCity"                                        ),
      headQuarterPhoneNumber        = optional  ( "headQuarterPhoneNumber",       "headQuarterPhoneNumber"                                        ),
      headQuarterState              = optional  ( "headQuarterState",             "headQuarterState"                                        ),
      headQuarterZipCode            = optional  ( "headQuarterZipCode",           "headQuarterZipCode"                                        ),
      ...
      menuKeywords                   = optional ( "menuKeywords",                 "menuKeywords"                                                            ),
      mobileNumber                  = optional  ( "mobileNumber",                 "mobileNumber"                                                            ),
      netPromoterScore              = optional  ( "netPromoterScore",             "netPromoterScore",             toBigDecimal                              ),
      numberOfProductsFittingInMenu = optional  ( "numberOfProductsFittingInMenu","numberOfProductsFittingInMenu",toInt         ),
      numberOfReviews               = optional  ( "numberOfReviews",              "numberOfReviews",              toInt         ),
      oldIntegrationId              = optional  ( "oldIntegrationId",             "oldIntegrationId"                                                        ),
      operatorLeadScore             = optional  ( "operatorLeadScore",            "operatorLeadScore",            toInt                                     ),
      otm                           = optional  ( "otm",                          "otm"                                                                     ),
      otmEnteredBy                  = optional  ( "otmEnteredBy",                 "otmEnteredBy"                                                            ),
      phoneNumber                   = optional  ( "phoneNumber",                  "phoneNumber"                                                             ),
      potentialSalesValue           = optional  ( "potentialSalesValue",          "potentialSalesValue",          toBigDecimal                              ),
      ...
      wayOfServingAlcohol           = optional  ( "wayOfServingAlcohol",          "wayOfServingAlcohol"                                                                     ),
      website                       = optional  ( "website",                      "website"                                                                     ),
      webUpdaterId                  = None                                                                                                                   ,
      weeksClosed                   = optional  ( "weeksClosed",                  "weeksClosed",                  toInt                                     ),
      yearFounded                   = optional  ( "yearFounded",                  "yearFounded",                  toInt                                     ),
