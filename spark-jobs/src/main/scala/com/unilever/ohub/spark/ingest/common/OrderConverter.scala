  ...
  override def toDomainEntity: DomainTransformer ⇒ Row ⇒ Order = { transformer ⇒
    row ⇒
      ...
      Order(
        ...
        totalGrossPrice = optional("totalGrossPrice", toBigDecimal),
        totalSurcharge = optional("totalSurcharge", toBigDecimal),
        wholesalerDistributionCenter = optional("wholesalerDistributionCenter"),
        wholesalerSellingPriceBasedAmount = optional("wholesalerSellingPriceBasedAmount", toBigDecimal),
        // other fields
