...
case class Product(
                    ...
                    materialTypeCode: Option[String],
                    availabilityStatus: Option[String],
                    unitOfMeasure: Option[String],
                    pricingReferenceMaterialCode: Option[String],
                    comCode: Option[String],
                    eanPallet: Option[String],
                    categoryCode: Option[String],
                    productPricingHierarchyLevel1: Option[String],
                    productPricingHierarchyLevel2: Option[String],
                    productPricingHierarchyLevel3: Option[String],
                    priceClassificationCode: Option[String],
                    volumeRebateGroupCode: Option[String],
                    pricingReferenceMaterialGroupCode: Option[String],
                    materialGroup2Code: Option[String],
                    materialGroup3Code: Option[String],
                    materialGroup5Code: Option[String],
                    consumerUnitPerCaseValue: Option[BigDecimal],
                    consumerUnitPerPalletValue: Option[BigDecimal],
                    casePerPalletValue: Option[BigDecimal],
                    layersPerPalletValue: Option[BigDecimal],
                    casesPerLayerValue: Option[BigDecimal],
                    palletsPerCaseValue: Option[BigDecimal],
                    netWeight: Option[BigDecimal],
                    grossWeight: Option[BigDecimal],
                    volume: Option[BigDecimal],
                    length: Option[BigDecimal],
                    width: Option[BigDecimal],
                    height: Option[BigDecimal],
                    caseHeight: Option[BigDecimal],
                    caseLength: Option[BigDecimal],
                    caseWidth: Option[BigDecimal],
                    caseGrossWeight: Option[BigDecimal],
                    consumerUnitHeight: Option[BigDecimal],
                    consumerUnitLength: Option[BigDecimal],
                    consumerUnitWidth: Option[BigDecimal],
                    consumerUnitGrossWeight: Option[BigDecimal],
                    palletLength: Option[String],
                    palletWidth: Option[BigDecimal],
                    palletHeight: Option[BigDecimal],
                    grossPalletWeight: Option[BigDecimal],
                    // other fields
