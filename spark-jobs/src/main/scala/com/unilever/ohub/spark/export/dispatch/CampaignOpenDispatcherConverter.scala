...
object CampaignOpenDispatcherConverter extends Converter[CampaignOpen, DispatchCampaignOpen] with TypeConversionFunctions with DispatchTypeConversionFunctions {
