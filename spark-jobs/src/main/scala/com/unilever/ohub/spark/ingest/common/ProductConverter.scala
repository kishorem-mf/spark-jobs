  ...
  override def toDomainEntity: DomainTransformer ⇒ Row ⇒ Product = { transformer ⇒
    row ⇒
      ...
      Product(
        ...
        categoryByMarketeer = optional("category"),
        ...
        materialTypeCode = optional("materialTypeCode"),
        availabilityStatus = optional("availabilityStatus"),
        unitOfMeasure = optional("unitOfMeasure"),
        pricingReferenceMaterialCode = optional("pricingReferenceMaterialCode"),
        comCode = optional("comCode"),
        eanPallet = optional("eanPallet"),
        categoryCode = optional("categoryCode"),
        productPricingHierarchyLevel1 = optional("productPricingHierarchyLevel1"),
        productPricingHierarchyLevel2 = optional("productPricingHierarchyLevel2"),
        productPricingHierarchyLevel3 = optional("productPricingHierarchyLevel3"),
        priceClassificationCode = optional("priceClassificationCode"),
        volumeRebateGroupCode = optional("volumeRebateGroupCode"),
        pricingReferenceMaterialGroupCode = optional("pricingReferenceMaterialGroupCode"),
        materialGroup2Code = optional("materialGroup2Code"),
        materialGroup3Code = optional("materialGroup3Code"),
        materialGroup5Code = optional("materialGroup5Code"),
        consumerUnitPerCaseValue = optional("consumerUnitPerCaseValue", toBigDecimal),
        consumerUnitPerPalletValue = optional("consumerUnitPerPalletValue", toBigDecimal),
        casePerPalletValue = optional("casePerPalletValue", toBigDecimal),
        layersPerPalletValue = optional("layersPerPalletValue", toBigDecimal),
        casesPerLayerValue = optional("casesPerLayerValue", toBigDecimal),
        palletsPerCaseValue = optional("palletsPerCaseValue", toBigDecimal),
        netWeight = optional("netWeight", toBigDecimal),
        grossWeight = optional("grossWeight", toBigDecimal),
        volume = optional("volume", toBigDecimal),
        length = optional("length", toBigDecimal),
        width = optional("width", toBigDecimal),
        height = optional("height", toBigDecimal),
        caseHeight = optional("caseHeight", toBigDecimal),
        caseLength = optional("caseLength", toBigDecimal),
        caseWidth = optional("caseWidth", toBigDecimal),
        caseGrossWeight = optional("caseGrossWeight", toBigDecimal),
        consumerUnitHeight = optional("consumerUnitHeight", toBigDecimal),
        consumerUnitLength = optional("consumerUnitLength", toBigDecimal),
        consumerUnitWidth = optional("consumerUnitWidth", toBigDecimal),
        consumerUnitGrossWeight = optional("consumerUnitGrossWeight", toBigDecimal),
        palletLength = optional("palletLength"),
        palletWidth = optional("palletWidth", toBigDecimal),
        palletHeight = optional("palletHeight", toBigDecimal),
        grossPalletWeight = optional("grossPalletWeight", toBigDecimal),
