...
import com.unilever.ohub.spark.export.businessdatalake.{AzureDLWriter,AnswerDLWriter}
...
object Answer extends DomainEntityCompanion[Answer] {
  ...
  override val dataLakeWriter: Option[AzureDLWriter[Answer]] = Some(AnswerDLWriter)
}
