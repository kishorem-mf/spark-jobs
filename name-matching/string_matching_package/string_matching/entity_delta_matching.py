...
def delta_load_operators(arguments):
    return main(arguments, preprocess_operators, postprocess_delta_operators)


def delta_load_contactpersons(arguments):
    return main(arguments, preprocess_contact_persons, postprocess_delta_contact_persons)
...
def main(arguments, preprocess_function, postprocess_function):
    ...
    :param callable preprocess_function: Function to preprocess the data, one of
            `entity_matching.preprocess_operators`, `entity_matching.preprocess_contact_persons`
