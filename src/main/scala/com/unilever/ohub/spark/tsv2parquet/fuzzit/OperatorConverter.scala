  ...
  override def toDomainEntity: (Row, DomainTransformer) ⇒ Operator = {
    (row, transformer) ⇒
      ...
      Operator(
        ...
        dateCreated                 = optional  ( CREATION_DATE,            "dateCreated",                  parseDateTimeForPattern() _                  ),
        dateUpdated                 = optional  ( CREATION_DATE,            "dateUpdated",                  parseDateTimeForPattern() _                  ),
        daysOpen                    = None                                                                                                               ,
        distributorName             = None                                                                                                               ,
        distributorOperatorId       = None                                                                                                               ,
        emailAddress                = optional  ( EMAIL,                    "emailAddress"                                                              ),
        faxNumber                   = optional  ( FAX,                      "faxNumber",                    cleanPhone(countryCode) _                   ),
        ...
        otm                         = None                                                                                                               ,
        otmEnteredBy                = None                                                                                                               ,
        phoneNumber                 = optional  ( PHONE_1,                  "phoneNumber",                  cleanPhone(countryCode) _                   ),
        region                      = None                                                                                                               ,
