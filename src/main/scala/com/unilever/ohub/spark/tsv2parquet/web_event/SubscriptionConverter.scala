...
import com.unilever.ohub.spark.tsv2parquet.{ DomainTransformer, SubscriptionEmptyParquetWriter }
...
object SubscriptionConverter extends WebEventDomainGateKeeper[Subscription] with SubscriptionEmptyParquetWriter {
  override protected[tsv2parquet] def toDomainEntity: DomainTransformer ⇒ Row ⇒ Subscription = { transformer ⇒ implicit row ⇒
